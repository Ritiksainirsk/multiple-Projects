...
export default function Scroll() {
  ...
  const handleToBottom = ()=>{
    window.scrollTo({
      top: document.documentElement.scrollHeight, // Scroll to the height of the entire document
  ...
  return (
    <div className="scrollbox">
      <h1>Scroll</h1>
      <button style={{marginBottom:"12px"}} onClick={handleToBottom}>Scroll To bottum</button>
      <p>
        Հայերեն Shqip لعربية Български Català 中文简体 Hrvatski Česky Dansk
